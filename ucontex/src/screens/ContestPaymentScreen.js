      ...
      <View style={{flex: 1}}>
        ...
        <KeyboardAwareScrollView
          ...
          <View style={detailSectionStyle}>
            <Text style={totalAmountInfoStyle}>Total: ₦ 100000</Text>
            <Form style={{paddingBottom: 20}}>
              <Item picker style={styles.inputOtherStyle}>
                <Picker
                  ...
                  // }
                >
                  <Picker.Item label="💳 Choose card" value="" />
                  <Picker.Item label="Visa" value="visa" />
                  <Picker.Item label="Mastar card" value="master" />
              ...
              <View style={{flexDirection: 'row'}}>
                <CheckBox color="#44a4f7" style={{marginRight: 20}} />
                <Text>Save card for future use</Text>
              </View>
              <Text style={styles.termsStyle}>
                By clicking make payment you accept our finicial terms and
                conditions
              </Text>
