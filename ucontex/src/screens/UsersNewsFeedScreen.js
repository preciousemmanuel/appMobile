...
class UserNewsFeedScreen extends React.PureComponent {
  constructor(props) {
    super(props);
    this.page = 1;
  ...
  componentWillMount() {
    const {navigation, userId, token, authUser, fetchUsersPost} = this.props;
        ...
        <Header
          ...
          <Body>
            <Text style={styles.headerTitleStyle}>
              {this.props.navigation.getParam('name') + ' Newsfeed'}
            </Text>
          </Body>
        </Header>
