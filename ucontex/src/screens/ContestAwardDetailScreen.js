...
class ContestAwardDetailScreen extends Component {
  ...
  renderJoinButton = () => {
    const {singleContestData, navigation} = this.props;
      ...
      <View style={topStyle}>
        ...
        <Animated.ScrollView
          ...
          <Animated.View
            ...
            <TouchableOpacity
              style={{justifyContent: 'center', alignItems: 'center'}}>
              <Text style={{color: '#44a4f7'}}>Award</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{justifyContent: 'center', alignItems: 'center'}}>
